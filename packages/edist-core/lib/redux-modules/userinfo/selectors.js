...
export const getUserToken = createSelector(userInfo, userInfo => userInfo.getIn(["details", "Token"]));
export const getUserDetails = createSelector(userInfo, userInfo => userInfo.get("details").toJS());